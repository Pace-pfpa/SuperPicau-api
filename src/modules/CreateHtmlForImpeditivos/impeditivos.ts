...
// HTML COM RESUMO DE IMPEDITIVOS - RURAL E MATERNIDADE
export class ImpeditivosHtmL {
    async execute(data: HtmlIImpeditivosDTO): Promise<string>{
        ...
        <body>
            ...
            <table>
                <thead>
                    <tr>
                        <th>SISLABRA CÔNJUGE</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>NOME: ${data.nomeConjuge}</td>
                    </tr>
                    <tr>
                        <td>CPF: ${data.cpfConjuge}</td>
                    </tr>    
                    <tr>
                        <td>VEÍCULO: ${data.veiculoConjuge}</td>
                    </tr>    
                    <tr>
                        <td>EMPRESA: ${data.empresaConjuge}</td>
                    </tr>
                    <tr>
                        <td>IMÓVEL: ${data.imovelConjuge}</td>
                    </tr>
                    <tr>
                        <td>ENDEREÇOS: ${data.enderecoConjuge}</td>
                    </tr>
                </tbody>
            </table>
