...
import { IInformacoesProcessoDTO } from "../dto";

export async function getComponenteDigitalIDRM(informacoesProcesso: IInformacoesProcessoDTO, documentoId: number): Promise<number> {
