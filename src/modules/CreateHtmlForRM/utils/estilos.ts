export const estilos = (): string => {
    return `
        <style type="text/css">
                    ...
                    .centralizado { text-align: center !important; text-indent: 0; }
                    .direita { text-align: right; text-indent: 0; }
                    .esquerda { text-align: left; text-indent: 0; }
                    p { text-indent: 25mm; text-align: center !important; font-family: "Times New Roman, Times", sans-serif; font-size: 11pt; margin-top: 0; margin-bottom: 0.2em; line-height: 1.2em; }
                    ...
                    p.numerado { text-indent: 0mm; text-align: center; font-family: "Times New Roman, Times", sans-serif; font-size: 11pt; margin-top: 0; margin-bottom: 0.2em; line-height: 1.2em; font-weight: normal; }
                    img { max-width: 185mm; }
                    ...
                    table td p { text-align: center; text-indent: 0mm; }
                    ul { font-family: "Times New Roman, Times", sans-serif; font-size: 11pt; text-align: center; list-style-type: circle; margin-left: 18mm; }
                    ol { font-family: "Times New Roman, Times", sans-serif; font-size: 11pt; text-align: center; margin-left: 18mm; }
                    blockquote { font-family: "Times New Roman, Times", sans-serif; font-size: 10pt; text-align: center; padding-left: 40mm; padding-right: 0mm; margin-top: 0; margin-bottom: 0.2em; margin-right: 0mm; }
